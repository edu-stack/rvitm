...
const Navbar = () => {
  ...
  return (
    ...
    <div style={{position: 'fixed' }} ref={scope}>
      ...
      <img src={logo} alt="logo"  className='navbar-logo' style={{minHeight: '25px', margin: '15px'}}/>
   </NavLink>
    ...
    <div className={`collapse navbar-collapse${collapsed ? ' ' : ' show'}`} id="navbarSupportedContent" style={{zIndex: '99998'}}>
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
        ...
        <li class="nav-item" style={{paddingLeft: '50px'}}>
        <NavLink
              className={({ isActive }) => isActive || window.location.pathname.startsWith("/faculty") ? 'active-link' : 'inactive-link'}
              onClick={toggleNavbar}
