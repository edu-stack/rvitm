      ...
      <nav class="mobile-bottom-nav">
        ...
        <div class="mobile-bottom-nav__item">
          <NavLink
            ...
            className={
              window.location.pathname.endsWith("/course") || window.location.pathname.endsWith("/material") || window.location.pathname.endsWith("/assignment")
                ? "active-button"
                : "inactive-button"
            }
          >
	...
	className={ window.location.pathname.endsWith("/profile") ? 'active-button' : 'inactive-button'}>
		<div class="mobile-bottom-nav__item-content">
			...
			{user.photoURL ?             <img
              src={user.photoURL}
              alt="Profile"
              style={ window.location.pathname.endsWith("/profile") ? {width: "20px", border: '1px solid #9e1d65'} : { width: "20px"} }
