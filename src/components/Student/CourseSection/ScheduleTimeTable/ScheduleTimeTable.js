       ...
       <div className="ScheduleTimeTable">
        <table className="mtable" >
          <tr >
            ...
            <th style={{color: 'Black'}}>9:00 - 10:00</th>
            <th style={{color: 'Black'}}>10:00 - 11:00</th>
            <th style={{color: 'Black'}}>11:00 - 11:20</th>
            <th style={{color: 'Black'}}>11:20 - 12:20</th>
            <th style={{color: 'Black'}}>12:20 - 1:20</th>
            <th style={{color: 'Black'}}>1:20 - 2:00</th>
            <th style={{color: 'Black'}}>2:00 - 3:00</th>
            <th style={{color: 'Black'}}>3:00 - 4:00</th>
            <th style={{color: 'Black'}}>4:00 - 4:45</th>
          </tr>
          <tbody>{Week}</tbody>
        </table>
      </div>
